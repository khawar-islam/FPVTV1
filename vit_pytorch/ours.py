...
from functools import partial
from Adaptive_Attention.attention import AttentionConv
# from refiner_utils import DLA, ClassBlock
from Adaptive_Attention.dcn import DeformableConv2d
...
class DWConv(nn.Module):
    ...
    def __init__(self, dim=768):
        ...
        #self.dwconv = DeformableConv2d(in_channels=dim, out_channels=dim, kernel_size=3, stride=1, padding=1, bias=True)
