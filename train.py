...
from vit_pytorch.SwinT.swin import SwinTransformer, swin_t, swin_b, swin_l, swin_s
...
if __name__ == '__main__':
    ...
    dataset = datasets.ImageFolder(root='/raid/khawar/dataset/facescrub_images_112x112/112x112',transform=transform)
    trainloader = DataLoader(dataset, batch_size=BATCH_SIZE, shuffle=True, num_workers=len(GPU_ID) + 6,
                             drop_last=False)
    ...
    BACKBONE_DICT = {"PVTV2": PyramidVisionTransformerV2(
        loss_type=HEAD_NAME,
        GPU_ID=GPU_ID,
        #patch_size=8, 
