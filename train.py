...
from backbone.model_resnet import ResNet_50, ResNet_101, ResNet_152, ResNet18
from backbone.model_irse import IR_50, IR_101, IR_152, IR_SE_50, IR_SE_101, IR_SE_152, IR_18, IR_SE_18
from head.metrics import ArcFace, CosFace, SphereFace, Am_softmax, ArcMarginProduct
...
wandb.login()
wandb.init(project='empirical', entity='khawar512')
...
if __name__ == '__main__':
    ...
    BACKBONE_NAME = cfg[
        'BACKBONE_NAME']  # support: ['ResNet_50', 'ResNet_101', 'ResNet_152', 'IR_50', 'IR_101', 'IR_152',
    ...
    HEAD_DICT = {'ArcFace': ArcFace(in_features=EMBEDDING_SIZE, out_features=NUM_CLASS, device_id=GPU_ID),
                 ...
                 'ArcMarginProduct': ArcMarginProduct(in_features=EMBEDDING_SIZE, out_features=NUM_CLASS)}
    ...
    for epoch in range(NUM_EPOCH):  # start training process
        ...
        if epoch == STAGES[0]:  # adjust LR for each training stage after warm up, you can also choose to adjust LR manually (with
             #slight modification) once plaueau observed
        ...
        print("Epoch {}/{}, Evaluation: LFW Acc: {}, CFP_FF Acc: {}, CFP_FP Acc: {}, AgeDB Acc: {}, CALFW Acc: {}, "
