...
configurations = {
    1: dict(
        ...
        DATA_ROOT='/raid/khawar/dataset/facescrub_images_112x112/112x112',
        ...
        BACKBONE_NAME='IR_18',
        # support: ['ResNet_50', 'ResNet_101', 'ResNet_152', 'IR_50', 'IR_101', 'IR_152', 'IR_SE_50', 'IR_SE_101', 'ResNet18'
        # 'IR_SE_152']
